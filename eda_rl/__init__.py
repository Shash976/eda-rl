...
Layout:
  ...
  funnel/  the multi-fidelity funnel (F0→F3), surrogate, candidate gen, promotion policies
  viz/     campaign reporting + comparison renders

(The retired first-generation system lives outside the package in legacy/.)
"""
