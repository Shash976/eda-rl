...
from eda_rl.common.physical_runner import run_elaborate, run_physical, run_synth_sta
from eda_rl.common.validate import validate
from eda_rl.common.constants import behavioral_cycles as _behavioral_cycles, AVG_CYCLES as _AVG_CYCLES
...
def _run_sim(lanes: int, acc_w: int) -> dict:
    ...
    if os.environ.get("PHYSICAL_MOCK"):
        ...
        return {"accuracy": acc, "correct": round(acc * 64), "n_total": 64,
                "avg_cycles": cyc}
    from eda_rl.gen1.runner import run_sim       # imported lazily: needs the Verilator binary
